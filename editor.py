...
from scripts.ground import Tilemap
...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Antos Game")
        ...
        self.assets = {
            'letter': load_images('tiles/letters'),
            'emoji': load_images('tiles/emojiSad', colorkey=(255, 255, 255)),
            'emojiHappy': load_images('tiles/emojiHappy', colorkey=(255, 255, 255)),
